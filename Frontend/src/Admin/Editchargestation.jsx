...
const Editchargestation = ({ match, history }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:7000/updatechargestation/${id}`, formData);
      console.log('Charge station updated successfully');
      alert('updated successfully')
      navigate('/achargepoints'); // Redirect to the charge points page
    } catch (error) {
