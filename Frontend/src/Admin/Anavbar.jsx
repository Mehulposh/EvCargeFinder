...
const Anavbar = () => {
  ...
  return (
    <Navbar bg="" variant="dark" expand="lg" style={{backgroundColor:"teal"}}>
      <Container>
        <Navbar.Brand><Link to='/ahome' style={{color:"white",textDecoration:"none"}}>Ev-Charge</Link></Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto" >
            ...
            <Link to="/achargepoints" style={{padding:"10px",color:"white",textDecoration:"none"}}>Charge Stations</Link>
            <Link to="/addchargestation" style={{padding:"10px",color:"white",textDecoration:"none"}}>Add charge Station</Link>
